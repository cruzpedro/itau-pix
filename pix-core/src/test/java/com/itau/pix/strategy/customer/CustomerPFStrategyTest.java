...
public class CustomerPFStrategyTest {

    @Mock
    private PixKeyRepository pixKeyRepository;

    private CustomerPFStrategy customerPFStrategy;
    private final KeyStrategyFactory keyStrategyFactory;
    private final PixKeyMapper pixKeyMapper;

    public CustomerPFStrategyTest() {
    ...
    @BeforeEach
    void setup() {
        customerPFStrategy = new CustomerPFStrategy(pixKeyRepository, keyStrategyFactory, pixKeyMapper);
    }
    ...
    void shouldCreate() {
        ...
        final PixKey pixKey = customerPFStrategy.create(getPixKeyDTO("teste@mail.com", KeyType.EMAIL));
    ...
    void shouldFailWhenCreateWithInvalidKey() {
        ...
        Assertions.assertThrows(PixValidationException.class, () -> customerPFStrategy.create(getPixKeyDTO("testemail.com", KeyType.EMAIL)));
    }
    ...
    void shouldFailWhenCreate() {
        ...
        Assertions.assertThrows(PixException.class, () -> customerPFStrategy.create(getPixKeyDTO("teste@mail.com", KeyType.EMAIL)));
    }

    @Test
    void shouldGetType() {
        Assertions.assertEquals(CustomerType.PF, customerPFStrategy.getType());
    }
