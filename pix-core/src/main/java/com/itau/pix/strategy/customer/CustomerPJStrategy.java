...
@Component
public class CustomerPJStrategy extends CustomerTemplate implements CustomerStrategy {
    private static final int MAX_RECORDS = 20;

    public CustomerPJStrategy(PixKeyRepository pixKeyRepository, KeyStrategyFactory keyStrategyFactory, PixKeyMapper pixKeyMapper) {
